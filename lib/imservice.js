...
function IMService(goEasy, GoEasy, pubsub) {
	//当前用户
...
IMService.prototype.findFriendById = function(userId, users) {
	let user = restApi.findUserById(userId, users);
