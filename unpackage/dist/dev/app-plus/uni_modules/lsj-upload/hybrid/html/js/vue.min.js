...
! function(e, t) {
	...
	function qn(n, r) {
		...
		if (!e(a) && !t(o._enterCb) && 1 === o.nodeType) {
			for (var s = a, u = s.css, l = s.type, f = s.enterClass, p = s.enterToClass, d = s.enterActiveClass, v =
					s.appearClass, h = s.appearToClass, m = s.appearActiveClass, g = s.beforeEnter, y = s.enter, _ =
					s.afterEnter, $ = s.enterCancelled, x = s.beforeAppear, w = s.appear, C = s.afterAppear, k = s
					.appearCancelled, A = s.duration, O = bo, S = bo.$vnode; S && S.parent;) S = S.parent, O = S
				.context;
			...
			if (!T || w || "" === w) {
				var E = T && v ? v : f,
					...
					B = o._enterCb = b(function() {
						R && (Un(o, N), Un(o, j)), B.cancelled ? (R && Un(o, E), M && M(o)) : D && D(o), o
							._enterCb = null
					});
	...
	function Wn(n, r) {
		function o() {
			k.cancelled || (n.data.show || ((a.parentNode._pending || (a.parentNode._pending = {}))[n.key] = n),
				h && h(a), x && (Hn(a, p), Hn(a, v), Bn(function() {
		...
		if (!t(a._leaveCb) && 1 === a.nodeType) {
			var u = s,
				...
				k = a._leaveCb = b(function() {
					a.parentNode && a.parentNode._pending && (a.parentNode._pending[n.key] = null), x && (Un(a,
							d), Un(a, v)), k.cancelled ? (x && Un(a, p), y && y(a)) : (r(), g && g(a)), a
						._leaveCb = null
				});
			_ ? _(o) : o()
		}
